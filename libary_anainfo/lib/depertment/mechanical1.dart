...
class Mechanical1 extends StatefulWidget {
  // final String id;
  const Mechanical1({Key? key}) : super(key: key);
  

  @override
  _Mechanical1State createState() => _Mechanical1State();
}

class _Mechanical1State extends State<Mechanical1> with TickerProviderStateMixin{
  String categories = "getbycategory?Category=Mechanical";


  Future<List<Food1>> fetchFood() async {
    final url = 'http://192.168.1.77:4000/users/getbycategory?Category=Mechanical&getbysubcategory=Manufacturing';
    print(url);
