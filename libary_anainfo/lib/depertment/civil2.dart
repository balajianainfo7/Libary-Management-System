...
class civil2 extends StatefulWidget {
  // final String id;
  const civil2({Key? key}) : super(key: key);
  

  @override
  _civil2State createState() => _civil2State();
}

class _civil2State extends State<civil2> with TickerProviderStateMixin{
  String categories = "getbycategory?Category=Mechanical";


  Future<List<Food1>> fetchFood() async {
    final url = 'http://192.168.1.77:4000/users/getbycategory?Category=Civil&getbysubcategory=Construction';
    print(url);
