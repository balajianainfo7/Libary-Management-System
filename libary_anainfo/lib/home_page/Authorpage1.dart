...
class AuthorPage1 extends StatefulWidget {
    AuthorPage1({Key? key});
  
  State<AuthorPage1> createState() => AuthorPage1State();
}
  class AuthorPage1State extends State<AuthorPage1> {
     ...
     Padding(
                    ...
                    children: [
                      ...
                      child: ClipRRect(
                        ...
                        child: Hero(
                          tag: '',
                          child: Image(image: AssetImage('images/Darren Ashby.jpg'),
                    ...
                    SizedBox(height: 20,),
                    Text("Darren Ashby", style: TextStyle(fontSize: 25, color: Colors.black, fontWeight: FontWeight.bold),),
