        ...
        children: <Widget>[
          Expanded(
            child: Container(
              ...
              child: ElevatedButton(
                style: ElevatedButton.styleFrom(padding: EdgeInsets.symmetric(vertical: 16),primary: Colors.blue,),
          ...
          Expanded(
            child: Container(
              ...
              child: ElevatedButton(
                style: ElevatedButton.styleFrom(padding: EdgeInsets.symmetric(vertical: 14),primary: Colors.blue,),
